...
public interface IGLUniformProvider {
	...
	public interface Resolution  extends IGLUniformProvider { public abstract void  onSupplyResolution(final IGLES20 pGLES20, final IGLScreenParameters pGLScreenParameters);      }
