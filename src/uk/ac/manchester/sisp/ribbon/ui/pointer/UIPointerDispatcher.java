...
public final class UIPointerDispatcher extends EventDispatcher<UIPointerEvent, UIPointerDispatcher> {
	...
	/* Static Declarations. */
	private static final int BUFFER_POINTER_SIZE = 4;
	...
	public UIPointerDispatcher(final float pCurrentTimeSeconds, final boolean pIsEnabled) {
		...
		Arrays.fill(this.getPointerBuffer(), new UIPointerEvent(pCurrentTimeSeconds, 0.0f, 0.0f, 0, EPointerAction.POINTER_RELEASE, EPointerIndex.LEFT, false));
	}
	...
	public final void onUpdatePointer(final float pCurrentTimeSeconds, final float pX, final float pY, final int pClickCount, EPointerAction pPointerAction, final EPointerIndex pPointerIndex, final boolean pIsShiftDown) {
		...
		final UIPointerEvent lUIPointerEvent = new UIPointerEvent(pCurrentTimeSeconds, pX, pY, pClickCount, pPointerAction, pPointerIndex, pIsShiftDown);
	...
	public final IVec2.W onCalculateTrend(final IVec2.W pCallback) {
